...
private:
	...
	ros::Subscriber sub_config_, sub_localizer_match_stat_, sub_waypoint_param_, sub_localizer_select_;
	...
	void localizer_select_callback(const std_msgs::Int32::ConstPtr &msg)
	{
...
public:
		...
		int localizer_select)
	{
		...
		sub_config_ = nh_.subscribe<autoware_config_msgs::ConfigLocalizerSwitch>(
		...
		sub_localizer_select_ = nh_.subscribe<std_msgs::Int32>(
					"/localizer_select", 10, &LocalizerSwitch::localizer_select_callback, this);
