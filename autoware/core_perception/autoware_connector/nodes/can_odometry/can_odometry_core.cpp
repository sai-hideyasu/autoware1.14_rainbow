...
void CanOdometryNode::callbackFromVehicleStatus_microbus(const autoware_can_msgs::MicroBusCan502::ConstPtr &msg)
{
	double vx = msg->velocity_mps / 2;//kmph2mps(msg->velocity_mps);
