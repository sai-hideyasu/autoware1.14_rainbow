...
roslaunch runtime_manager setup_tab_rainbow.launch x:=6.2 y:=0.0 z:=2.5 yaw:=3.13759 pitch:=0.0 roll:=0.0 frame_id:=/base_link child_frame_id:=/velodyne period_in_ms:=10 &
sleep 3
